...
inline flatbuffers::Offset<Example> CreateExampleDirect(
    ...
    uint64_t id = 0,
    std::vector<flatbuffers::Offset<DLFS::Annotation>> *annotations = nullptr,
    const std::vector<uint8_t> *image = nullptr,
    uint64_t width = 0,
    uint64_t height = 0,
    uint64_t idx = 0) {
  auto file_name__ = file_name ? _fbb.CreateString(file_name) : 0;
  auto annotations__ = annotations ? _fbb.CreateVectorOfSortedTables<DLFS::Annotation>(annotations) : 0;
...
inline flatbuffers::Offset<Dataset> CreateDatasetDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    uint64_t id = 0,
    std::vector<flatbuffers::Offset<DLFS::Example>> *examples = nullptr,
    std::vector<flatbuffers::Offset<DLFS::Category>> *categories = nullptr) {
  auto examples__ = examples ? _fbb.CreateVectorOfSortedTables<DLFS::Example>(examples) : 0;
  auto categories__ = categories ? _fbb.CreateVectorOfSortedTables<DLFS::Category>(categories) : 0;
